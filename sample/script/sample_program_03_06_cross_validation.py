...
results_train.to_csv("sample/output/03_06/estimated_y_in_detail_ols.csv")
...
plt.ylabel("estimated y")  # y 軸の名前
plt.gca().set_aspect("equal", adjustable="box")  # 図の形を正方形に
plt.savefig("sample/output/03_06/actual_vs_estimated_in_cv_ols.png")  # 図の保存
plt.show()  # 以上の設定で描画
...
results_in_cv.to_csv("sample/output/03_06/estimated_y_in_cv_in_detail_ols.csv")
