...
# X に対応する名前を、元のデータセットにおける X の名前に変更
...
standard_regression_coefficients.to_csv("sample/output/03_05/standard_regression_coefficients_ols.csv")
...
estimated_y_new.to_csv("sample/output/03_05/estimated_y_ols.csv")
...
plt.savefig("sample/output/03_05/actual_vs_estimated_ols.png")  # 図の保存
plt.show()  # 以上の設定で描画
