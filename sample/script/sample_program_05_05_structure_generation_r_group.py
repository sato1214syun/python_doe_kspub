...
dataset_main_fragments = pd.read_csv("test_data/main_fragments.csv", index_col=0)
# 主骨格のフラグメントの SMILES
main_fragments = list(dataset_main_fragments.iloc[:, 0])
# 側鎖のフラグメントの SMILES のデータセットの読み込み
dataset_sub_fragments = pd.read_csv("test_data/sub_fragments.csv", index_col=0)
